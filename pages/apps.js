...
commentContainer.querySelector('#send-comment-btn').addEventListener('click', () => {
...
function displayComments(){
    ...
    dataArray.comments.forEach(comment => {
        ...
        comment.replies.forEach(reply => {
          ...
          newReply.querySelector('.replying-to').innerText = `@${reply.replyingTo} `;
...
function setUpUserButtons(commentElement, comment) {
  ...
  commentElement.querySelector('#edit-btn').addEventListener('click', () => {
      commentElement.querySelector('.comment-edit-placeholder').classList.remove('hidden');
      commentElement.querySelector('.comment-edit-placeholder').querySelector('textarea').value = commentElement.querySelector('.comment-text').innerText;
      commentElement.querySelector('.comment-content').classList.add('hidden');
      commentElement.querySelector('.comment-edit-placeholder').querySelector('#comment-edit-btn').addEventListener('click', () => {
          editComment(comment, commentElement.querySelector('.comment-edit-placeholder').querySelector('textarea').value);
      });
  });
...
function setUpReplyButton(commentElement, comment) {
  ...
  commentElement.querySelector('#reply-btn').addEventListener('click', () => {
    ...
    replyContainer.querySelector('textarea').innerText = `@${comment.user.username}, `;
